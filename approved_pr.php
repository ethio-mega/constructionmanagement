              ...
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                              ...
                              if($found_user > 0) {
                                ...
                                <?php while($row = mysqli_fetch_array($res)) {    
                                  ...
                                  <tr>
                                    ...
                                    <input name="delivered_by[]"  value=" <?php echo $row["requested_by"];?> " class="form-control" type="hidden">   
                                    ...
                                    <th hidden><?php echo $row["requested_by"]; ?></th>  
                                    <th hidden><?php echo $row["unit"]; ?></th>
                                    <th><?php echo  $row["quantity"]; ?></th>
                                    <th hidden><?php echo $row["approved_date"];?></th>
                                    <th hidden><?php echo $row["date_to_submit"]; ?></th>
                ...
                if(isset($_POST["sub"])){ 
                  ...
                  $db = new DB_Functions();           
                   ...
                   $delivered_by=$_POST['delivered_by'][$val];
                   $unit=$_POST['unit'][$val];
                   $unit_price=$_POST['unit_price'][$val];
                   $total_price=$_POST['total_price'][$val];
                   $remark=$_POST['remark'][$val];
                   
                   $db->inserttoStore($material_desc,$unit,$quantity,$unit_price,$total_price,$remark);
                   $db->inserttoInventoryRec($material_desc,$quantity,$delivered_by,$unit,$unit_price,$total_price,$remark);
